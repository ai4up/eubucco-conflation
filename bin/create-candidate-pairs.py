...
# datasets_all = [CandidatePairs.load(f'/p/projects/eubucco/data/conflation-training-data/candidate-pairs-{dataset_a}-{dataset_b}.pickle') for dataset_a, dataset_b in [('gov', 'osm'), ('gov', 'msft'), ('osm', 'msft')]]
...
candidate_pairs = CandidatePairs(
        ...
        pairs=pd.concat([cp.pairs for cp in datasets_all]),
    )

candidate_pairs.save('/p/projects/eubucco/data/conflation-training-data/candidate-pairs.pickle')
